...
CSL_Status CSL_ccdcSetColPatConfig(CSL_CcdcHandle hndl, CSL_CcdcColPatConfig * data)
{
  ...
  CSL_FINS(hndl->regs->CCOLP, ISIF_CCOLP_CP01_0, data->colPat0[0][0]);
  CSL_FINS(hndl->regs->CCOLP, ISIF_CCOLP_CP03_2, data->colPat0[0][1]);
  CSL_FINS(hndl->regs->CCOLP, ISIF_CCOLP_CP05_4, data->colPat0[1][0]);
  CSL_FINS(hndl->regs->CCOLP, ISIF_CCOLP_CP07_6, data->colPat0[1][1]);

  CSL_FINS(hndl->regs->CCOLP, ISIF_CCOLP_CP11_0, data->colPat1[0][0]);
  CSL_FINS(hndl->regs->CCOLP, ISIF_CCOLP_CP13_2, data->colPat1[0][1]);
  CSL_FINS(hndl->regs->CCOLP, ISIF_CCOLP_CP15_4, data->colPat1[1][0]);
  CSL_FINS(hndl->regs->CCOLP, ISIF_CCOLP_CP17_6, data->colPat1[1][1]);
