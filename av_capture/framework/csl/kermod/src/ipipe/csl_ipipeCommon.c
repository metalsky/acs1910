...
CSL_Status CSL_ipipeSetDpcConfig(CSL_IpipeHandle hndl, CSL_IpipeDpcConfig * data)
{
  ...
  hndl->regs->DPC_OTF_3_D_THR = data->otf3CorThres;
  hndl->regs->DPC_OTF_3_D_SLP = data->otf3CorThresSlope;
  hndl->regs->DPC_OTF_3_D_MIN = data->otf3CorThresMin;
  hndl->regs->DPC_OTF_3_D_MAX = data->otf3CorThresMax;
