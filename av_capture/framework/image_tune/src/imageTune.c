...
//  OSA_printf(" \r\n IMAGE_TUNE_GetParams = curPrm.ipipePrm %d, %d, %d ", gIMAGE_TUNE_ctrl.curPrm.ipipePrm.rgb2yuv.matrix[0][0],gIMAGE_TUNE_ctrl.curPrm.ipipePrm.rgb2yuv.matrix[1][1], gIMAGE_TUNE_ctrl.curPrm.ipipePrm.rgb2yuv.offset[0]);
...
//#ifdef IMAGE_TUNE_TEST_GET_PRM  //For testing
//    for( ; pID<IMAGE_TUNE_MAX_PARAMSET; pID++){   //For testing
//#endif   //For testing
