...
static int davinci_set_backg_color(struct vpbe_backg_color *backg_color)
{
...
static __init int davinci_display_init(void)
{
	...
	backg_color.clut_select = 0;	/* 2: RAM CLUT 1:ROM1 CLUT 0:ROM0 CLUT */
	backg_color.color_offset= 0xff;	/* index of color */
	davinci_set_backg_color(&backg_color);
