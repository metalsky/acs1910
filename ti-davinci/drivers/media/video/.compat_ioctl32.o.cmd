cmd_drivers/media/video/compat_ioctl32.o := /home/pamsimochen/workdir/toolchain/montavista/pro/devkit/arm/v5t_le/bin/arm_v5t_le-gcc -Wp,-MD,drivers/media/video/.compat_ioctl32.o.d  -nostdinc -isystem /home/pamsimochen/workdir/toolchain/montavista/pro/devkit/arm/v5t_le/bin/../lib/gcc/armv5tl-montavista-linux-gnueabi/4.2.0/include -D__KERNEL__ -Iinclude  -include include/linux/autoconf.h -include linux/marker.h -mlittle-endian -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Os -marm -fno-omit-frame-pointer -mapcs -mno-sched-prolog -mabi=aapcs-linux -mno-thumb-interwork -D__LINUX_ARM_ARCH__=5 -march=armv5te -mtune=arm9tdmi  -msoft-float -Uarm -fno-omit-frame-pointer -fno-optimize-sibling-calls  -fno-stack-protector -Wdeclaration-after-statement -Wno-pointer-sign -Idrivers/media/dvb/dvb-core   -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(compat_ioctl32)"  -D"KBUILD_MODNAME=KBUILD_STR(compat_ioctl32)" -c -o drivers/media/video/.tmp_compat_ioctl32.o drivers/media/video/compat_ioctl32.c

deps_drivers/media/video/compat_ioctl32.o := \
...
drivers/media/video/compat_ioctl32.o: $(deps_drivers/media/video/compat_ioctl32.o)
