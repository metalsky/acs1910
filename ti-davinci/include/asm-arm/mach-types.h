...
#ifdef CONFIG_MACH_DA8XX_EVM
# ifdef machine_arch_type
#  undef machine_arch_type
#  define machine_arch_type	__machine_arch_type
# else
#  define machine_arch_type	MACH_TYPE_DA8XX_EVM
# endif
# define machine_is_davinci_da8xx_evm()	(machine_arch_type == MACH_TYPE_DA8XX_EVM)
#else
...
#if defined(CONFIG_NAKED_BOOT) && (machine_arch_type == __machine_arch_type)
#error "CONFIG_NAKED_BOOT may be used with a single-machine config only"
#endif
