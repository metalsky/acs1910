cmd_ltt/facilities/ltt-facility-loader-process.o := /home/pamsimochen/workdir/toolchain/montavista/pro/devkit/arm/v5t_le/bin/arm_v5t_le-gcc -Wp,-MD,ltt/facilities/.ltt-facility-loader-process.o.d  -nostdinc -isystem /home/pamsimochen/workdir/toolchain/montavista/pro/devkit/arm/v5t_le/bin/../lib/gcc/armv5tl-montavista-linux-gnueabi/4.2.0/include -D__KERNEL__ -Iinclude  -include include/linux/autoconf.h -include linux/marker.h -mlittle-endian -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Os -marm -fno-omit-frame-pointer -mapcs -mno-sched-prolog -mabi=aapcs-linux -mno-thumb-interwork -D__LINUX_ARM_ARCH__=5 -march=armv5te -mtune=arm9tdmi  -msoft-float -Uarm -fno-omit-frame-pointer -fno-optimize-sibling-calls  -fno-stack-protector -Wdeclaration-after-statement -Wno-pointer-sign   -DMODULE -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(ltt_facility_loader_process)"  -D"KBUILD_MODNAME=KBUILD_STR(ltt_facility_loader_process)" -c -o ltt/facilities/.tmp_ltt-facility-loader-process.o ltt/facilities/ltt-facility-loader-process.c

deps_ltt/facilities/ltt-facility-loader-process.o := \
  ltt/facilities/ltt-facility-loader-process.c \
  ...
  ltt/facilities/ltt-facility-loader-process.h \
  include/ltt/ltt-facility-id-process.h \

ltt/facilities/ltt-facility-loader-process.o: $(deps_ltt/facilities/ltt-facility-loader-process.o)
